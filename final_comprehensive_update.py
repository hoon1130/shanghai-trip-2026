...
def update_spots_comprehensive():
    ...
    new_spots_data = '''        const initialSpots = [
            ...
            {cat: "핵심", nameKo: "숙소 (IFC Residence)", nameZh: "上海国金汇", addr: "", subway: "2/14호선 陆家嘴(Lujiazui)역 6번출구 도보 3분"},
    ...
    # 2. Ensure migration logic force-updates EXISTING items to clean addr and update subway
