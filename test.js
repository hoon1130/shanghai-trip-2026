        ...
        const smartMapDict = {
            ...
            "숙소": {name: "上海国金汇", addr: "上海市浦도新区世纪大道8号"},
            ...
            "징안쓰": {name: "静安寺", addr: "上海시静安区南京西路1686号"},
            ...
            "릴리안": {name: "莉莲蛋挞(新世界大丸百货店)", addr: "上海市黄浦区南京东路228号新세계大丸百货"},
        ...
        function openBaiduMap(place) {
            ...
            // 별도 브라우저 새창을 강제하기 위해 _system 또는 앵커 태그 활용
